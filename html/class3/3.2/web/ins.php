...
$title_na_db = "三年級主題(2)善行滿天下的王善人：";//網站名稱
$pss = "12";//每頁頁數
//我應該做的事,可以增加只要加上流水號最多十個
$idoyes[0] = "觀察別人的善行，向他學習。";
$idoyes[1] = "主動觀察家人的需要，幫忙他完成。";
$idoyes[2] = "每天想一想自己有沒有做錯什麼事。";
$idoyes[3] = "背孝經：身體髮膚，受之父母，不敢毀傷，孝之始也。立身行道，揚名於後世，以顯父母，孝之終也。";
//評語//可以無限增加
