...
$title_na_db = "五年級主題(8)台灣之光-王建民：";//網站名稱
$pss = "12";//每頁頁數
//我應該做的事,可以增加只要加上流水號最多十個
$idoyes[0] = "我懂得肯定自己，並能說出自己的優點。";
$idoyes[1] = "我會反省影響我成功的壞習慣，並且改正。";
$idoyes[2] = "我每天充滿信心到學校學習。";
$idoyes[3] = "今天的我比昨天的我更進步。";
$idoyes[4] = "我會留意台灣人在世界各地的傑出表現，並向他們看齊。";
//評語//可以無限增加
